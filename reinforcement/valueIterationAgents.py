...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        for iter in range(self.iterations):
            tempValues = self.values.copy() # not on-line update
            for s in States:
                if self.mdp.isTerminal(s):
                    continue
                tempValues[s] = max([self.getQValue(s,a) for a in self.mdp.getPossibleActions(s)])
